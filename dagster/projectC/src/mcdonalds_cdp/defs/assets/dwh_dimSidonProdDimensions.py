...
@asset(
    non_argument_deps={
        AssetKey(["projectC", "dbo_sensors"]),
        AssetKey(["projectC", "dbo_sensor_tys"]),
        AssetKey(["projectC", "dbo_devices"]),
        AssetKey(["projectC", "dbo_device_tys"]),
        AssetKey(["projectC", "dbo_sublocations"]),
        AssetKey(["projectC", "dbo_sublocation_tys"])
    },
